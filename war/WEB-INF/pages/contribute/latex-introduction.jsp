				...
				<div class="box box-solid practice-problem">
					...
					<div class="box-body">
						...
						<p>
							...
							characters. There are two different "modes" of input, inline expressions and displayed equations (which are centered, on their own line).
							<ul>
								<li>To create an <b>inline expression</b>, begin the expression with <code>\</code><code>(</code> and use <code>\</code><code>]</code> as a closing statement.</li>
								<li>To create a <b>displayed equation</b>, begin the expression with <code>\</code><code>[</code> and use <code>\</code><code>]</code> to close the statement.</li>
								<li>Another way to create a <b>displayed equation</b> is to, begin the expression with <code>$</code><code>$</code> and use <code>$</code><code>$</code> to close the statement.</li>
