 ...
 *      This file should be included in all pages
 !**/
;var left_side_width=220;$(function(){$("[data-toggle='offcanvas']").click(function(f){f.preventDefault();if($(window).width()<=992){$(".row-offcanvas").toggleClass("active");$(".left-side").removeClass("collapse-left");$(".right-side").removeClass("strech");$(".row-offcanvas").toggleClass("relative")}else{$(".left-side").toggleClass("collapse-left");$(".right-side").toggleClass("strech")}});$(".btn").bind("touchstart",function(){$(this).addClass("hover")}).bind("touchend",function(){$(this).removeClass("hover")});$("[data-toggle='tooltip']").tooltip();$("[data-widget='collapse']").click(function(){var g=$(this).parents(".box").first();var f=g.find(".box-body, .box-footer");if(!g.hasClass("collapsed-box")){g.addClass("collapsed-box");$(this).children(".fa-minus").removeClass("fa-minus").addClass("fa-plus");f.slideUp()}else{g.removeClass("collapsed-box");$(this).children(".fa-plus").removeClass("fa-plus").addClass("fa-minus");f.slideDown()}});$(".navbar .menu").slimscroll({height:"200px",alwaysVisible:false,size:"3px"}).css("width","100%");$('.btn-group[data-toggle="btn-toggle"]').each(function(){var f=$(this);$(this).find(".btn").click(function(g){f.find(".btn.active").removeClass("active");$(this).addClass("active");g.preventDefault()})});$("[data-widget='remove']").click(function(){var f=$(this).parents(".box").first();f.slideUp()});$(".sidebar .treeview").tree();function d(){var h=$(".main-header").height()-($(".main-footer").height());var g=$(window).height();var f=$(".left-side").height();if(g>=f){$(".content, .left-side").css("min-height",g-h)}else{$(".content, .left-side").css("min-height",f-h)}}d();$(window).resize(function(){window.setTimeout(function(){d();fix_sidebar()},1000)});fix_sidebar();$("input[type='checkbox']:not(.simple), input[type='radio']:not(.simple)").iCheck({checkboxClass:"icheckbox_minimal",radioClass:"iradio_minimal"});$(".login-button").click(function(){$("#login-modal").removeClass("hidden")});$(".login-action").click(function(){$("#login-modal").addClass("hidden")});$("#close-ad").click(function(){$(this).closest(".ad").remove()});$(".wysihtml5-beam-me-up").wysihtml5();$(".nav .dropdown .dropdown-toggle").click(function(){var j=$(this).data("type");var h=$(this).data("user");var g=$(".label",this);var f=parseInt(g.text());if(f>0){$.ajax({type:"POST",url:"/mark-menu-items-read",data:"userId="+h+"&type="+j})}g.fadeOut().text("0")});$(".knob").knob();var b=$(".affirm-consent-check-box");var a=$(".affirm-consent-button");$(b).click(function(){$(this).toggleClass("checked");$(a).toggleClass("disabled")});$("#affirm-consent-modal").each(function(){var f=this;$(a).click(function(){var j=$(b).hasClass("checked");if(j){var g=$(this).data("user");$.ajax({type:"POST",url:"/affirm-consent",data:"userId="+g});$(f).remove()}else{var h={border:"1px solid #f56954"};$(affirmConsentCheckbox).css(h)}})});var c=$(".rating-system-horizontal .rating-instructions");var e=$(".info-button",c);$(e).click(function(){$(c).toggleClass("no-height")})});function fix_sidebar(){if(!$("body").hasClass("fixed")){return}var a={height:($(window).height()-$(".header").height())+"px"};$(".sidebar").slimscroll({height:($(window).height()-$(".header").height())+"px",color:"rgba(0,0,0,0.2)"});$(".sidebar").parent().css(a);$(".sidebar").css(a)}$(window).load(function(){
/*! pace 0.4.17 */
